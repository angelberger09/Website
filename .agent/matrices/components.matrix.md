...
## Addendum — 2026-06-25 09:18 ET

COMP-003, COMP-004, and COMP-008 now refine that first-screen route orientation into a lightweight contact sheet. `app/page.jsx` adds `home-hero-contact-sheet` and `home-hero-route-slip__preview` markup, while `app/home-entry-contact-sheet-pass.css` turns the four route links into mini route-photo cards without filters, blend modes, fake preview assets, or animated layers.
