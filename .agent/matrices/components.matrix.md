...
## Addendum — 2026-06-25 13:40 ET

COMP-004 and COMP-008 now include homepage front-room highlight visual centers: `app/page.jsx` renders `home-note-piece__visual` from existing highlight copy, and `app/home-highlight-photo-pass.css` makes those highlights feel more image-led without adding fake screenshots, fake products, fake portfolio work, or private material.

## Addendum — 2026-06-25 16:34 ET

COMP-006 now includes Notes support/state photo slips: `app/notes-support-photo-slips-pass.css` adds abstract paper/photo centers and clipped labels to the support and reader-state notes without changing Blog feed data or implying fake note artwork.
...
## Addendum — 2026-06-25 19:49 ET

COMP-005 now includes a content-bearing footer studio mark: `app/site-chrome.jsx` renders `studio-footer__mark-photo` and `app/footer-studio-mark-photo-pass.css` styles it as an honest abstract paper/photo center so the shared footer identity no longer remains mostly text-only beside image-led route slips.
