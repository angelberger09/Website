...
| Agent files | `.agent/changes/2026-06-28-home-hero-scale-guard.md`, `.agent/changes/2026-06-28-home-hero-ux-entry-board.md`, `.agent/changes/2026-06-28-home-hero-front-desk-repair.md`, `.agent/changes/2026-06-28-home-hero-wordless-entry.md`, `.agent/changes/2026-06-28-home-hero-wordless-entry-refinement.md`, `.agent/matrices/home-hero-scale-guard.matrix.md` |
...
| Satisfaction state | partially satisfied; visible hero wording removed, leftover pseudo-wording suppressed, route-choice entry preserved and tightened |
