...
| DESIGN-030 | Text Paper Snippets | Makes section headings readable clipped paper slips. |
...
| METRIC-029 | Text Lives In Paper Snippets | Markdown headings now behave as placed text slips. |
