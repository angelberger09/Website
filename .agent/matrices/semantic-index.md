...
| DESIGN-017 | Design Pattern | Polaroid Frame Core Motif | `app/page.jsx`, `app/hero.css`, `public/atmosphere/*` | Dark backing plus cream torn frame used as reusable material structure | LESSON-016 | active |
...
| INT-010 | Interaction | Leftward Default-Open Menu Reveal | `app/page.jsx`, `app/typography.css` | Pages menu starts open and reveals links left of the Pages control | LESSON-013 | active |
