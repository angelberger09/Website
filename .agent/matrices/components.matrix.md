...
| COMP-004 | Studio Page Cards | PAGE-001 | Present destinations as friendly doors | Grid of four linked cards with entry cues | Rounded material cards may use polaroid frames only when the middle is filled with readable destination content | LESSON-002, LESSON-003, LESSON-015, LESSON-018, LESSON-019, LESSON-021 | Must stay synced with page routes and avoid decorative empty card frames | active |
...
| COMP-008 | Filled Page Sections | PAGE-001, PAGE-002, PAGE-003, PAGE-004, PAGE-005 | Add route-specific depth beyond first-pass cards | Data-driven section arrays render principles, lanes, details, pathways, and readiness promises | Uses existing material cards, wide cards, lists, soft link rows, stronger paper-collage surface cues, and content-filled polaroid treatments when frames are used | LESSON-001, LESSON-002, LESSON-018, LESSON-019, LESSON-021 | Keep content public-safe, readable, and honest | active |
