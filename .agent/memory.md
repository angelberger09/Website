...
- `/Website/about/` explains the public studio shape, working principles, next-path choices, and routes visitors toward notes or portfolio. Its principles and pathways now render as taped paper-note boards, and its reusable continuity band renders as a paper trail instead of a broad shared UI panel.
