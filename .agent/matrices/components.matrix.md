...
| COMP-005 | Shared Site Chrome | All pages | Keep the page system visually cohesive | Header, atmosphere layer, footer, page intro, and detail card | Reusable cream/paper/polaroid/gloss material language that reads as paper before glass | LESSON-001, LESSON-002, LESSON-010, LESSON-015, LESSON-016, LESSON-019 | Shared changes affect every route | active |
