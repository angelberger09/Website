...
| COMP-003 | Component | Scroll Title Sequence | `app/page.jsx`, `app/globals.css` | Quiet arrival moment: Welcome → To → Soft Strange Studio | LESSON-001 | active |
...
| DESIGN-002 | Design Pattern | Large Editorial Type | `app/globals.css` | Authored visual identity | LESSON-001 | active |
