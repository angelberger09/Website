...
| COMP-008 | Filled Page Sections | PAGE-001, PAGE-002, PAGE-003, PAGE-004, PAGE-005 | Add route-specific depth beyond first-pass cards | Data-driven section arrays render principles, lanes, readiness criteria, details, pathways, Store launch checklist, Store availability states, Store feed contract fields, Notes source-readiness fields, Portfolio feed contract fields, Portfolio record states, and promises | Uses material cards, wide cards, lists, soft link rows, stronger paper-collage surface cues, content-filled polaroid treatments, and less uniform rounding; Store availability states now have a partial placed-paper implementation through `store-snippet-list`, `store-state-snippet`, `store-availability-card`, and staggered cut-paper styling in `app/paper-card-pass.css`; remaining Store material targets need deployed visual review before adding more styling | LESSON-001, LESSON-002, LESSON-004, LESSON-018, LESSON-019, LESSON-021, LESSON-022, FEEDBACK-012, FEEDBACK-015, FEEDBACK-016, FEEDBACK-017, FEEDBACK-018 | Keep content public-safe, readable, honest, and clear about non-live inventory or source readiness; avoid repeated styling churn once a Store target is already partially satisfied | active |
