...
|---|---|---|---|---|---|---|---|---|
| COMP-001 | Floating Header | All pages through `app/layout.jsx`, `app/paper-card-pass.css`, and `app/paper-header-pass.css` | Keep personal identity and navigation visible | Fixed at top while scrolling | Top-attached paper material tab with direct links, existing grain/dust/scratch texture, subtle lower-edge irregularity, and visible soft drop shadow | LESSON-001, LESSON-002, LESSON-011, LESSON-015, LESSON-020 | Could crowd small screens if too many routes are added or lose readability if paper texture is too strong | active |
