...
- `/Website/portfolio/` gives the first public project/archive cards, archive readiness lanes, archive lanes, a future Portfolio feed contract, staged record states, a publishing rhythm, and related routes into notes or store. Its opening archive, readiness lanes, lane sequence, feed contract, record states, and process rhythm now render as Portfolio-specific paper/photo boards, ledger cards, state notes, and process ribbons instead of generic shared panels.
