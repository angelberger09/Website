...
- Workflow reliability problems should leave public-safe recovery packets in `.agent/feedback/workflow-packets/`; use a second minimal recovery workflow in future implementation so failure context becomes append-only project memory instead of being lost in action logs.
